  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: "故障排除", autogenerate: { directory: "troubleshooting" } },
      ...
      // 說明中心在 monorepo kano-faq-main/kano-help-center/，編輯此頁連到該路徑
      editLink: {
        baseUrl:
          typeof process.env.PUBLIC_EDIT_LINK_BASE_URL === "string" &&
          process.env.PUBLIC_EDIT_LINK_BASE_URL.length > 0
            ? process.env.PUBLIC_EDIT_LINK_BASE_URL
            : "https://github.com/NextKitchen/kano-faq-main/edit/main/kano-help-center/",
      },
